...
from config import UPLOAD_FILE_PATH, TEMP_DOWNLOAD_FOLDER_PATH, RECORDS_FOLDER_PATH, ELASPIC_MANY_URL
...
record_response, new_url = get_chunk_record_status(UPLOAD_FILE_PATH, "../test_files/Records_Test")
...
if response == ResponseMessages.COMPLETED:
    ...
    download_result_file(driver, TEMP_DOWNLOAD_FOLDER_PATH)
    # move downloaded file to folder where it belongs and organize naming etc.
    organize(TEMP_DOWNLOAD_FOLDER_PATH, UPLOAD_FILE_PATH, downloaded_filename='allresults.txt')
